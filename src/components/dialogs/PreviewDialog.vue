<template>
  <el-dialog v-model="preview.visible" :title="preview.name || '文件预览'" width="80vw" top="5vh" destroy-on-close>
    ...
    <template #footer>
      <el-button type="success" @click="$emit('download', preview.row)">下载文件</el-button>
